    ...
    return (
        <div>
            ...
            <div style={{ position: "fixed", height: "90%", width: "20%", top: "10%" }} className="bg-secondary">
                ...
                <button style={{ height: "10%", width: "100%" }} className="btn btn-secondary rounded-0 border border-primary">All Locations</button>
                <button style={{ height: "10%", width: "100%" }} className="btn btn-secondary rounded-0 border border-primary">Favourite Locations</button>
                <button style={{ height: "10%", width: "100%" }} className="btn btn-secondary rounded-0 border border-primary">Logout</button>
            </div>
            <Home />
        </div>
    );
